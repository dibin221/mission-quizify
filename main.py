...
from services.vectordb import ChromaCollectionCreator
from services.quizhandler import QuizGenerator,QuizManager
    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                embed_client = EmbeddingClient(**VertexAIConfig.EMBED_CONFIG.value)
        ...
        with st.container():
            ...
            with st.form("MCQ"):
                ...
                def update_index(direction):
                    print(update_index)
                    st.session_state.question_index=quiz_manager.next_question_index(direction)
                    print("update_index ",st.session_state["question_index"])
